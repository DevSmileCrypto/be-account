package io.cryptobrewmaster.ms.be.account.exception;

import io.cryptobrewmaster.ms.be.account.exception.util.ControllerExceptionUtil;
...
import static io.cryptobrewmaster.ms.be.account.exception.util.ControllerExceptionUtil.prepareErrorMessage;
